...
<header>
    ...
    <div class="first">
        <a class="logo" href="/adm"><img src="/images/folheto.png" alt="Folheto logo"><div class="text">Folheto</div></a>
    </div>
    ...
    <div class="second">
        ...
        <a class="user-options" href="/projetofolheto/adm.folheto/actions/signout.php">
            <img src="/images/person.svg" alt="Expandir opções de perfil">
            <img src="/images/expand_more.svg" alt="Expandir opções de perfil">
        </a>
    </div>
